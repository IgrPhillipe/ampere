...
>(({ className, children, ...props }, ref) => (
	<AccordionPrimitive.Panel ref={ref} {...props}>
		<div className="h-(--accordion-panel-height) overflow-hidden text-sm transition-[height] data-starting-style:h-0 data-ending-style:h-0">
