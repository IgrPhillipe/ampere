...
- README com informações da equipe e do produto

---

## Entrega 01 — 31/08/2026

- Histórias de usuário (mínimo 7) em BDD, escrita em `.md` no GitHub — [`docs/produto/user-stories.md`](produto/user-stories.md)
...
- Commits semanais de código no main
- GitHub Issues atualizado (print no README)
- Screencast do sistema com as novas histórias (YouTube)
- Screencast de explicação do código das novas histórias (YouTube)
...
- Commits semanais de código no main
- GitHub Issues atualizado (print no README)
- Screencast final do sistema (YouTube)
- Screencast de explicação do código (YouTube)
...
- A solução desenvolvida (características, histórias, diferencial)
- Fluxo de trabalho (planejamento, requisitos, desenvolvimento, qualidade)
- Ferramentas utilizadas (com links)
- Lições aprendidas
- Demonstração do produto (vídeo curto ou ao vivo)
