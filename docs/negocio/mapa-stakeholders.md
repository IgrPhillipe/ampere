...
Fase: **Imersão** ([`../processo.md`](../processo.md)). Responsável: Afonso Araújo.
Fonte: [Figma: Mapa de Stakeholders](https://www.figma.com/board/9MbYu3RwGB9twN6NJmUWso/Mapa-de-Stakeholders).
...
São os dois lados do ciclo de retrabalho descrito em [`premissas-desafio.md`](premissas-desafio.md#impacto). São também os dois lados que o [`benchmarking.md`](benchmarking.md) mostrou desassistidos: nenhuma ferramenta do mercado valida o cálculo antes do envio nem aponta onde está o erro.

Stakeholders de apoio relevantes para a construção da solução:

- **Área de normas técnicas** (secundário, dentro): fonte das regras que o motor de cálculo aplica
...
O **usuário do MVP**, entre os dois do anel secundário, ainda não foi decidido. Ver [`questoes-em-aberto.md`](../produto/questoes-em-aberto.md).
