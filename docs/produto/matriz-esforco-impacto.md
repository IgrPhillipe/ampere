...
- **Board:** [FigJam: Matriz Impacto x Esforço](https://www.figma.com/board/f0pJpuS2qghO8PZTmgbaKB/Matriz-Impacto-x-Esfor%C3%A7o)

## Quadrantes

| Quadrante | Eixos | Leitura |
| :--- | :--- | :--- |
| **Essencial** | Fácil, alto impacto | Retorno rápido |
| **Estratégico** | Difícil, alto impacto | O ganho potencial justifica o esforço |
| **Indiferente** | Fácil, baixo impacto | Avaliar se o impacto pode aumentar |
| **Luxo** | Difícil, baixo impacto | Avaliar se é necessário |
...
**Indiferente e Luxo estão vazios.** As histórias são derivadas da solução escolhida em [`ideacao.md`](ideacao.md), e as ideias que não a serviam já saíram na etapa de descarte do brainstorming. A matriz não separa o que entra do que sai. Ela define a ordem de construção do que já entrou.
