...
- **Definição da solução final** com justificativa
- **Histórias de usuário** e **matriz esforço × impacto**
...
- **Construção em Sprints**, evoluindo o sistema gradualmente
- **Registro do desenvolvimento no GitHub**
- **Atualização da documentação** ao longo das entregas
...
| Imersão | Processo atual do cliente | [`negocio/processo-submissao.md`](negocio/processo-submissao.md) |
