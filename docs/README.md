...
| :--------- | :------ | :------- |
| Reunião    | [ciclo-projeto-eletrico.html](ciclo-projeto-eletrico.html) | Apoio visual à reunião com a Neoenergia: o ciclo do projeto etapa a etapa e as perguntas em aberto. Abrir no navegador |
...
Para evitar que a mesma informação seja mantida em dois lugares:
...
Os arquivos `.md` são o registro e mandam nos fatos. O `.html` é derivado, feito para conduzir a reunião. Em conflito, o markdown vence, e ao alterar um os dois são atualizados na mesma leva.
