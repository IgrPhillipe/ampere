...
O método é autocontido entre DIS-NOR-053 e DIS-NOR-030, ambas gratuitas. Sem a correção, o alerta poderia ter levado o time a gastar tempo ou dinheiro com um documento desnecessário.
...
Classificar algo como bloqueio exige verificar a dependência, não apenas constatar que o documento é pago. O critério não é se a norma é acessível, e sim se o que está sendo construído depende dela.
