...
A busca independente antecipou a resposta e acertou o alvo. A reunião do dia 18 foi de validação, e não de descoberta, conforme a aposta registrada abaixo.

## Aprendizado

Nem toda lacuna depende do cliente. Antes de transformar uma dúvida em pergunta de reunião, é preciso verificar se a resposta é pública. Neste caso, a diferença foi entre uma reunião de "nos expliquem o problema" e uma de "validem nosso entendimento".

O mesmo vale para as dúvidas restantes sobre a norma: a divergência entre o Quadro 33 da 053 e a Tabela 13 da 030 parecia pergunta para a distribuidora e foi resolvida pela leitura do Anexo I, item 13. Antes de escrever a pergunta, ler a fonte inteira.
